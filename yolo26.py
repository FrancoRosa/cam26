...
def setup_model(args):
    ...
    if model_path.endswith(".pt") or model_path.endswith(".torchscript"):
        ...
        assert False, "{} is not pytorch or onnx model".format(model_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        required=False,
        default="./yolo26n.pt",
        help="model path, could be .pt or onnx",
    )
    parser.add_argument(
        "--target", type=str, default="rk3576", help="target RKNPU platform"
    )
    ...
    parser.add_argument(
        "--img_folder", type=str, default="../model", help="img folder path"
    )
    parser.add_argument(
        "--coco_map_test", action="store_true", help="enable coco map test"
    )
